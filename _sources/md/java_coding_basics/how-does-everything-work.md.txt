...
The gradle is basically the file that tells the project everything you want to import. This allows the project to implement and import more complex things like {ref}`implement`. It is very important that anytime you modify these files, you make sure you only add to them or change versions slightly, as if something is broken, it compromises your project almost completely.
...
You will perform a Gradle Sync  ![gradleSync.png](gradleSync.png)
